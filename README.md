...
La capa de infraestructura contiene las implementaciones de las interfaces definidas en el dominio, en este caso de los repositorios que utilizan la base de datos MongoDB. La configuración de qué repositorio utilizar es configurable al importar el módulo, en  este caso solamente está disponible MongoDB.
